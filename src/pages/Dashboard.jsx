...
import { Link } from "react-router-dom"; // Removed Route and Routes since they are not being used
import TournamentPage from "../component/tournament/TournamentPage"; // Import TournamentPage
import BookingPage from "../component/Booking/BookingPage"; // Corrected import path for BookingPage
...
const Dashboard = () => {
  ...
  const handleTournamentsClick = () => {
    setContent(<TournamentPage />); // Assuming TournamentPage is a component that renders tournament info
  };

  const handleBookingsClick = () => {
    setContent(<BookingPage />); // Corrected the function name to match
  };

  return (
    <div className="flex min-h-screen bg-gray-100">
      {/* Sidebar */}
      <div className="w-50 bg-blue-900 text-white p-9 min-h-screen">
        <h2 className="text-xl font-semibold mb-8">Admin Panel</h2>
        <ul>
          <li className="mb-4">
            <button
          ...
          <li className="mb-4">
            <button
              onClick={handleBookingsClick} // Corrected function name here
              className="text-gray-300 hover:text-white"
            >
              Bookings
            </button>
